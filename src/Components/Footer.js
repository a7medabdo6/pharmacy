...
const Footer = () => {
  return (
    <div style={{backgroundColor:"#DD1717"}} className='w-100  footer  d-flex justify-content-center align-items-center flex-column'> 
        ...
        <div className='    d-flex my-2 justify-content-center align-items-center ' style={{height:"2px",backgroundColor:"grey",width:"85%"}}></div>
        <div className='w-100   my-2 d-flex justify-content-center align-items-center '>
