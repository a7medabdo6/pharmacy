...
const products = () => {
 ...
 style={{backgroundColor:"#0F4392",borderRadius:10,height:"150px",position:"relative"}}>
   ...
   <SearchInput />
    ...
    <div className='d-flex justify-content-start align-items-center  mt-3 flex-wrap' style={{width:"95%"}}>
      <div className='d-flex justify-content-center align-items-center ' style={{backgroundColor:"#DD1717",borderRadius:'4px',width:"32px",height:"28px"}}>
      <p className={styles.label}>all</p>

      </div>

      <div className='d-flex justify-content-center align-items-center mx-2' style={{backgroundColor:"rgba(221, 23, 23, 0.2)",borderRadius:'4px',width:"119px",height:"28px"}}>
  ...
  <div  className='d-flex justify-content-start align-items-center flex-wrap ' style={{width:"95%"}}>
  <div className={styles.greybox}>
    ...
    <Image
        ...
        <div className='d-flex justify-content-between mt-3 align-items-center flex-wrap ' style={{width:"95%"}}>
