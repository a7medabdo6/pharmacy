...
const Notifications = () => {
  return (
    ...
    <div className='w-100 d-flex mt-3 justify-content-center align-items-center flex-column'style={{backgroundColor:"white",borderRadius:"4px"}} >
      ...
      <div style={{width:"95%"}} className=' d-flex justify-content-start ms-3 mt-3 align-items-center '>
        <p style={{fontWeight:"bold"}}>new</p>
      </div>

      <div className=' d-flex justify-content-center my-2 align-items-start boxnotify flex-column '>
        <p className='titlenotify ms-3 mb-0'>Order Placed Successfully. Thank you for </p>
      ...
      <div style={{backgroundColor:"grey",width:"95%",height:"1px"}}></div>
